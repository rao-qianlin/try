...
class Link(models.Model):
	...
	#weight = models.PositiveIntegerField(default=1,choices=zip(int(range(1.6)),int(range(1,6))),verbose_name="权重",help_text="权重高展示顺序靠前")
...
class SideBar(models.Model):
	...
	def content_html(self):
		...
		if self.display_type == self.DISPLAY_HTML:
			...
			result = render_to_string('config/blocks/sidebar_post.html',context)
		elif seif.display_type ==DISPLAY_COMMENT:
			context = {
